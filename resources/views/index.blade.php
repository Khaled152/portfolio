            ...
            <li class="project-item  active" data-filter-item data-category="web design">
              <a href="#">
                ...
                <figure class="project-img">
                  ...
                  <img src="{{asset('images/project-6.png')}}" alt="metaspark" loading="lazy">
                </figure>
            ...
            <li class="project-item  active" data-filter-item data-category="web development">
              <a href="#">
                ...
                <figure class="project-img">
                  ...
                  <img src="{{asset('images/project-7.png')}}" alt="summary" loading="lazy">
                </figure>
            ...
            <li class="project-item  active" data-filter-item data-category="applications">
              <a href="#">
                ...
                <figure class="project-img">
                  ...
                  <img src="{{asset('images/project-8.jpg')}}" alt="task manager" loading="lazy">
                </figure>
          ...
          <ul class="blog-posts-list">
            ...
            <li class="blog-post-item">
              <a href="#">
                ...
                <figure class="blog-banner-box">
                  <img src="{{asset('images/blog-3.jpg')}}" alt="Design digest #80" loading="lazy">
                </figure>
            ...
            <li class="blog-post-item">
              <a href="#">
                ...
                <figure class="blog-banner-box">
                  <img src="{{asset('images/blog-4.jpg')}}" alt="UI interactions of the week" loading="lazy">
                </figure>
            ...
            <li class="blog-post-item">
              <a href="#">
                ...
                <figure class="blog-banner-box">
                  <img src="{{asset('images/blog-5.jpg')}}" alt="The forgotten art of spacing" loading="lazy">
                </figure>
            ...
            <li class="blog-post-item">
              <a href="#">
                ...
                <figure class="blog-banner-box">
                  <img src="{{asset('images/blog-6.jpg')}}" alt="Design digest #79" loading="lazy">
                </figure>
